...
export default function TaskDetail() {
    ...
    const {data: task, isLoading} = useSWR<Omit<ItemLineItem, "comments"> & { comments: any[] }>(`/tasks/${id}`, fetcher);
                        ...
                        <div className="col-span-3">
                            <div className="space-y-4">
                                {task.events.map((event, index) => (
                                    <div key={index} className="relative pl-6 pb-4 border-l-2 border-primary last:border-l-0">
